    ...
    results.append(
        {
            ...
            'urls': [{'title': 'Wolfram|Alpha', 'url': resp.request.headers.get('Referer', 'https://www.wolframalpha.com/')}],
        }
    )

    results.append(
        {
            'url': resp.request.headers.get('Referer', 'https://www.wolframalpha.com/'),
