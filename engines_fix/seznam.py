...
def request(query, params):
    # index fetch needs a generous timeout - seznam.cz is slow from some IPs
    response_index = get(base_url, headers=params['headers'], raise_for_httperror=True, timeout=15)
