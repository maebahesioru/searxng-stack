...
class ResultContainer:
    ...
    def close(self):
        ...
        # snapshot iteration - late-arriving engines can still add to the map
        # while we close (async tasks that ignore cancellation); a live dict
        # iteration then raises RuntimeError: dictionary changed size during iteration
        for result in list(self.main_results_map.values()):
