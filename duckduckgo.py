...
def request(query: str, params: "OnlineParams") -> None:
    ...
    # GET-style request: encode the form data into the URL query string.
    # DDG's bot blocker flags form-POSTs from non-browser clients; GET passes.
    # NOTE: this SearXNG version does NOT forward engine 'params' to the HTTP
    # layer, so the query MUST be embedded in the URL.
    from urllib.parse import urlencode

    params["url"] = ddg_url + "?" + urlencode(data)
